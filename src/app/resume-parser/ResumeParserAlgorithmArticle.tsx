  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the WeResume
      ...
      <Paragraph>
        And that is everything about the WeResume parser algorithm :)
      </Paragraph>
      <Paragraph>
        Written by <Link href="https://github.com/zakkou">Hamdi</Link> on
        June 2023
      </Paragraph>
    </article>
  );
