        ...
        {!hasUsedAppBefore ? (
            ...
            {!hasAddedResume && (
              <>
                ...
                <SectionWithHeadingAndCreateButton
                  heading="No tienes un CV aún?"
                  buttonText="Crealo desde cero"
                />
              </>
            )}
          </>
          ...
          <>
            {!hasAddedResume && (
              <>
                <SectionWithHeadingAndCreateButton
                  heading="You have saved data from a previous session"
                  buttonText="Continue from where I left off"
                />
                <OrDivider />
              </>
            )}
            <h1 className="font-semibold text-gray-900">
            Overwrite data with a new CV
            </h1>
            <ResumeDropzone
              onFileUrlChange={onFileUrlChange}
              className="mt-5"
