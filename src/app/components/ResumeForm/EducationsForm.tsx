        ...
        return (
          ...
          >
            ...
            <Input
              ...
              labelClassName="col-span-4"
              name="degree"
              placeholder="Computer Engineering and Informatics"
              value={degree}
              onChange={handleEducationChange}
            />
            <Input
              label="Grade or Evaluation"
              labelClassName="col-span-2"
              name="gpa"
              placeholder="6.8"
              value={gpa}
            ...
            <div className="relative col-span-full">
              <BulletListTextarea
                ...
                name="descriptions"
                placeholder="Free paragraph space to list additional activities, courses, awards, etc."
                value={descriptions}
                onChange={handleEducationChange}
