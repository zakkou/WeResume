      ...
      >
        ...
        {!hasFile ? (
          <>
            ...
            >
              Search for a pdf file or drag it here
            </p>
            <p className="flex text-sm text-gray-500">
              <LockClosedIcon className="mr-1 mt-1 h-3 w-3 text-gray-400" />
              The information in the file is used locally in your browser and never transferred to third parties
            </p>
          </>
        ) : (
          ...
          {!hasFile ? (
            ...
            <>
              {!playgroundView && (
                ...
                >
                  Import & Continue <span aria-hidden="true">→</span>
                </button>
              )}
              <p className={cx(" text-gray-500", !playgroundView && "mt-6")}>
              Note:  {!playgroundView ? "Import" : "Parser"} Works best with 
                Single-column CVs
              </p>
            </>
          )}
