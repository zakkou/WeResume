...
const WORK_EXPERIENCE_KEYWORDS_LOWERCASE = ['work', 'experience', 'employment', 'history', 'job', 
                                            "experiencia", "laboral", "trabajo", "historial", "empleos"];
// prettier-ignore
const JOB_TITLES = ['Accountant', 'Administrator', 'Advisor', 'Agent', 'Analyst', 'Apprentice', 'Architect', 'Assistant', 'Associate', 'Auditor', 'Bartender', 'Biologist', 'Bookkeeper', 'Buyer', 'Carpenter', 'Cashier', 'CEO', 'Clerk', 'Co-op', 'Co-Founder', 'Consultant', 'Coordinator', 'CTO', 'Developer', 'Designer', 'Director', 'Driver', 'Editor', 'Electrician', 'Engineer', 'Extern', 'Founder', 'Freelancer', 'Head', 'Intern', 'Janitor', 'Journalist', 'Laborer', 'Lawyer', 'Lead', 'Manager', 'Mechanic', 'Member', 'Nurse', 'Officer', 'Operator', 'Operation', 'Photographer', 'President', 'Producer', 'Recruiter', 'Representative', 'Researcher', 'Sales', 'Server', 'Scientist', 'Specialist', 'Supervisor', 'Teacher', 'Technician', 'Trader', 'Trainee', 'Treasurer', 'Tutor', 'Vice', 'VP', 'Volunteer', 'Webmaster', 'Worker',
                    'Comptable', 'Administrateur', 'Conseiller', 'Agent', 'Analyste', 'Apprenti', 'Architecte', 'Assistant', 'Associé', 'Auditeur', 'Serveur', 'Biologiste', 'Comptable', 'Acheteur', 'Charpentier', 'Caissier', 'PDG', 'Employé de bureau', 'Coopérative', 'Co-fondateur', 'Consultant', 'Coordinateur', 'CTO', 'Développeur', 'Designer', 'Directeur', 'Chauffeur', 'Éditeur', 'Électricien', 'Ingénieur', 'Externe', 'Fondateur', 'Freelance', 'Chef', 'Stagiaire', 'Concierge', 'Journaliste', 'Ouvrier', 'Avocat', 'Leader', 'Gestionnaire', 'Mécanicien', 'Membre', 'Infirmier', 'Officier', 'Opérateur', 'Opération', 'Photographe', 'Président', 'Producteur', 'Recruteur', 'Représentant', 'Chercheur', 'Ventes', 'Serveur', 'Scientifique', 'Spécialiste', 'Superviseur', 'Professeur', 'Technicien', 'Commerçant', 'Apprenti', 'Trésorier', 'Tuteur', 'Vice', 'Vice-président', 'Volontaire', 'Webmaster', 'Travailleur'];
